...
public class PDFServiceImpl implements PDFService {
    ...
    public static final String FONT = "core_service/src/main/resources/fonts/timesnewromanpsmt.ttf";
    ...
    public void createPdf() throws IOException {
        ...
        document.add(new Paragraph("Договор аренды и лизинга грузового транспортного средства")
                .setBold());
